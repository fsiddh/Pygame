...
while run:
    ...
    # Fixes invisibility bug. Even after killing our enemy it didn't used to die,
    # it only used to get invisible. By following code the collision only happens when enemy is visible.
    if enemy.visible:
